export const translations = {
  ...
  ar: {
    chooseLanguage:'اختر لغتك', english:'English', arabic:'العربية', continue:'متابعة',
    yourInfo:'معلوماتك', phone:'رقم الهاتف', countryCode:'رمز الدولة', age:'العمر', telegram:'اسم مستخدم تيليجرام (اختياري)',
    required:'يرجى إكمال الحقول المطلوبة.', invalidAge:'يرجى إدخال عمر صحيح.', checking:'جارٍ التحقق...', used:'تم استخدام رقم الهاتف هذا من قبل.', connection:'تعذر الاتصال. حاول مرة أخرى.',
    welcome:'لغز الأزواج', intro:'اعثر على الأزواج المتطابقة، وأبقِ الشريط فارغًا، وأزل كل القطع للفوز!', how:'طريقة اللعب', rule1:'اضغط على أي قطعة متاحة لنقلها إلى الشريط.', rule2:'تختفي كل قطعتين متطابقتين تلقائيًا.', rule3:'امسح اللوحة قبل امتلاء الشريط.', start:'ابدأ اللعبة', loading:'جارٍ تحميل صور اللغز...',
    tray:'شريط المطابقة', gameOver:'انتهت اللعبة', loseText:'امتلأ الشريط. حاول مرة أخرى!', playAgain:'العب مرة أخرى',
    congrats:'مبروك! لقد ربحت 100$', claimText:'استلم ربحك على موقع Time4Bets.', claim:'استلم الآن', redirecting:'جارٍ التحويل...', statusSaving:'جارٍ حفظ النتيجة...'
  }
};
